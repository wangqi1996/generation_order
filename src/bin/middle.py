...
parser.add_argument('--log_path', type=str, default="/home/wangdq/save/log/middle_2",
                    help="The path for saving tensorboard logs. Default is ./log")

parser.add_argument('--saveto', type=str, default="/home/wangdq/save/model/middle_2",
...
parser.add_argument("--valid_path", type=str, default="/home/wangdq/save/valid/middle_2",
...
def run(**kwargs):
    ...
    args.reload = True
    # args.pretrain_path = '/home/wangdq/save/model/middle_result/middle.best.final'
