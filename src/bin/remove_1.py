...
parser.add_argument('--log_path', type=str, default="/home/wangdq/njunlp_code/save/log/remove_1",
                    help="The path for saving tensorboard logs. Default is ./log")

parser.add_argument('--saveto', type=str, default="/home/wangdq/njunlp_code/save/model/remove_1/",
...
parser.add_argument("--valid_path", type=str, default="/home/wangdq/njunlp_code/save/valid/remove_1",
...
def run(**kwargs):
    ...
    args.batch_size = 512
    args.beam_size = 1
    args.model_path = r'/home/wangdq/njunlp_code/save/model/remove_1/Transform.best.final'
...
# CUDA_VISIBLE_DEVICES=0 nohup python -u /home/wangdq/njunlp_code/test/src/bin/remove_1.py >> /home/wangdq/njunlp_code/save/remove_1.txt  2>&1 &

# CUDA_VISIBLE_DEVICES=0 python -u /home/wangdq/njunlp_code/test/src/bin/remove_1.py