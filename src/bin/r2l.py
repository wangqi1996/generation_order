...
from src.main import train, translate
...
parser.add_argument('--log_path', type=str, default="/home/wangdq/njunlp_code/save/log/r2l",
                    help="The path for saving tensorboard logs. Default is ./log")

parser.add_argument('--saveto', type=str, default="/home/wangdq/njunlp_code/save/model/r2l/",
...
parser.add_argument("--valid_path", type=str, default="/home/wangdq/njunlp_code/save/valid/r2l",
...
def run(**kwargs):
    ...
    args.config_path = r'/home/wangdq/njunlp_code/test/configs/configs_r2l.yaml'
    args.use_gpu = True
    ...
    args.batch_size = 512
    args.beam_size = 1
    args.model_path = r'/home/wangdq/njunlp_code/save/model/r2l/Transform.best.final'
