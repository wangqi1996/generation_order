...
class MultiHeadedAttention(nn.Module):
    ...
    def forward(self, key, value, query, mask=None, enc_attn_cache=None, self_attn_cache=None):
        ...
        scores = torch.matmul(query_up, key_up.transpose(2, 3))  # [batch_size, head_count, key_len, query_len]
        ...
        context = self._combine_heads(torch.matmul(drop_attn, value_up))  # query_len = value_len
